...
3. Clone this repository with the following command and URL: `git clone https://github.com/ivanbaradi/to-do`.
4. Command **cd** to that repository.
5. Run application by executing `npm start`.